...
/**
 * Utility for downloading the {@link MCAvailableVersionsManifest} and associated {@link
 * MCVersionManifest}s for each available version.
 *
...
public class MCVersionManifestLoader
{
    ...
    /**
     * A cached copy of the {@link MCAvailableVersionsManifest} of available Minecraft versions and their
     * applicable information, including URL for the corresponding package JSON.
     *
     * @since 1.0
     */
     ...
     *
     * @throws IOException if unable to download the {@link MCAvailableVersionsManifest} or applicable {@link
     *                     MCVersionManifest}
     * @since 1.0
     */
    public MCVersionManifest downloadVersionManifest( String id ) throws IOException {
        ...
        List< MCAvailableVersionsManifest.Version > availableVersions
                = MCAvailableVersionsManifest.getVersions();
        ...
        if ( availableDesiredVersion != null ) {
            File versionManifestFile = SynchronizedFileManager.getSynchronizedFile(
                    LocalPathManager.getMinecraftVersionsManifestFilePath( id + ".json" ) );
     ...
     *
     * @return {@link MCAvailableVersionsManifest} of available Minecraft versions and their applicable
     *         information
     *
     * @throws IOException if unable to download the {@link MCAvailableVersionsManifest}
     * @since 1.0
     */
    private MCAvailableVersionsManifest downloadVersionsManifest() throws IOException {
        File versionsManifestFile = SynchronizedFileManager.getSynchronizedFile(
                LocalPathManager.getMinecraftVersionsManifestFilePath( "versions.json" ) );
