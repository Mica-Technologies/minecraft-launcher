...
public class GameMod extends ManagedGameFile
{
     ...
     */
    void updateLocalFile( com.micatechnologies.minecraft.forgelauncher.utilities.objects.GameMode gameAppMode )
    throws ModpackException
    {
        if ( ( gameAppMode == com.micatechnologies.minecraft.forgelauncher.utilities.objects.GameMode.CLIENT &&
                clientReq ) || (
                gameAppMode == com.micatechnologies.minecraft.forgelauncher.utilities.objects.GameMode.SERVER &&
                        serverReq ) ) {
