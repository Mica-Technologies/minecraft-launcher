...
public class LocalizationManager
{
    ...
    /**
     * The prefix of all error logs that are submitted via {@link com.micatechnologies.minecraft.forgelauncher.files.Logger#logError(String)}.
     *
     * @since 1.0
     */
    ...
    /**
     * The prefix of all warning logs that are submitted via {@link com.micatechnologies.minecraft.forgelauncher.files.Logger#logWarning(String)}.
     *
     * @since 1.0
     */
    ...
    /**
     * The prefix of all standard logs that are submitted via {@link com.micatechnologies.minecraft.forgelauncher.files.Logger#logStd(String)}.
     *
     * @since 1.0
     */
    ...
    /**
     * The prefix of all debug logs that are submitted via {@link com.micatechnologies.minecraft.forgelauncher.files.Logger#logDebug(String)}.
     *
     * @since 1.0
     */
