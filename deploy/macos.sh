...
find "micaforgelauncher-signed.app" -type f -not -path "*/Contents/PlugIns/*" -not -path "*/Contents/MacOS/JavaLauncher" -not -path "*libapplauncher.dylib" -exec codesign --timestamp --entitlements /Users/alexanderhawk/Git/Personal/Minecraft-Forge-Launcher/src/main/resources/darwin/micaforgelauncher.entitlements -s "Developer ID Application" --options runtime -v {} \;
find "micaforgelauncher-signed.app/Contents/Java/jdk" -type f -not -path "*/legal/*" -not -path "*/man/*" -exec codesign -f --timestamp --entitlements /Users/alexanderhawk/Git/Personal/Minecraft-Forge-Launcher/src/main/resources/darwin/micaforgelauncher.entitlements -s "Developer ID Application" --options runtime -v {} \;
