...
function_doSubmit() {
	...
	xcrun altool -t osx -f micaforgelauncher.dmg --primary-bundle-id com.micatechnologies.minecraft.forgelauncher.LauncherCore --notarize-app -u hawkaj@icloud.com -p "@keychain:APPLENOTARIZE" | tee -a notarize.log
}
